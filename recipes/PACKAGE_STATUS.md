...
| :--- | :---: | :---: | :--- |
| **`recipes/system/`** | 27 | ✅ 100% Verified | Toolchain Sistem, Kernel Headers, C Library & Inisialisasi OpenRC |
| **`recipes/core/`** | 87 | ✅ 100% Verified | Utilitas Dasar, CLI Tools, Filesystem, Networking & Service Daemons |
| **`recipes/extra/`** | 113 | ✅ 100% Verified | Bahasa Pemrograman, Desktop Environment, Library Grafis, Audio & Qt6/KDE |
