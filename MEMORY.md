...
| *2026-09-20* | *Cargo Host Leakage & Zero-Host Builds* | *Cargo membaca `~/.cargo/` host saat sandbox membaca root `/`, memicu kegagalan di rootfs murni tanpa internet* | *Mendokumentasikan Idea #13 di `IDEA_FOR_FORGE.md` dan mengisolasi `CARGO_HOME="${srcdir}/.cargo_home"` pada resep Rust (ADR-083)* |
