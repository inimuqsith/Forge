...
65. **ADR-065 (Upstream GNU GCC v16.2.0 SHA256 Checksum Alignment):** Memperbarui checksum SHA256 resep `gcc` v16.2.0 sesuai tarball rilis resmi hulu GNU FTP untuk memastikan kelulusan verifikasi integritas unduhan.
...
| *2026-09-20* | *GCC v16.2.0 SHA256 Checksum Mismatch* | *Nilai hash SHA256 tarball hulu GCC v16.2.0 di GNU FTP diperbarui* | *Memperbarui nilai hash SHA256 di `recipes/system/gcc/recipe.toml` (ADR-065)* |
